...
We believe that's the reason why libraries like [rx-angular/state](https://www.rx-angular.io/docs/state) and [@ngrx/component-store](https://ngrx.io/guide/component-store) are created. While Angular is evolving rapidly and we tend to avoid third party dependencies for state management, we wrote a simple and small solution ourselves.
